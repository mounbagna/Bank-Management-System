...
<%
    ...
    try {
        ...
        // Retrieve all users
        String query = "SELECT email,phone,name, amount, accountNum,  description FROM loan";
        ...
        while (rs.next()) {
            ...
            user.put("amount", rs.getDouble("amount"));
            user.put("accountNum", rs.getDouble("accountNum"));
                        ...
                        <table border="1">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><%= user.get("name") %></td>
                                    <td><%= user.get("amount") %></td>
                                    <td><%= user.get("accountNum") %></td>
                                    <td><%= user.get("description") %></td>
                                    <td>
                                        <form action="deleteLoan" method="post" onsubmit="return confirm('Are you sure you want to delete this loan?');">
                                            <input type="hidden" name="accountNum" value="<%= user.get("accountNum") %>"/>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">Welcome to BANKIFY, a project brought to you by a sixth semester
					 student from the Islamic University of Technology. Hailing from Cameroon, I is passionate about revolutionizing the
					 digital banking experience for users across borders.</p>
				</div>
...
<!-- Contact Section-->
	<section class="page-section" id="contact">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-secondary mb-0">Approve
				Loan</h2>
			<!-- Icon Divider-->
			...
			<div class="row justify-content-center">
				<div class="col-lg-8 col-xl-7">
					<form action="LoanACK" method="post">
						<!-- Name input-->
